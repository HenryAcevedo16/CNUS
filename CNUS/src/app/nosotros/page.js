...
export default function NosotrosPage() {
  return (
    <main className="w-full bg-white">
      ...
      {/* ─── BANNER ─────────────────────────────────────────────── */}
      <section className="relative w-full h-[280px] md:h-[450px] flex flex-col overflow-hidden mb-[200px]">
        <div
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center text-center px-4">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-light tracking-wide text-white text-center mt-10 md:mt-0 max-w-4xl">
            Sobre Nosotros
          </h1>
        </div>
      </section>
